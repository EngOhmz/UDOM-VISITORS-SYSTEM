                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <p style="margin:0 0 20px;color:#64748b;font-size:14px;line-height:1.6;">
                                Your visit request has been <strong style="color:#0a5c3c;">approved</strong>. Use the verification code below when you arrive on campus.
                            </p>

                            <table width="100%" cellpadding="0" cellspacing="0" style="background:#ecfdf5;border:2px solid #0a5c3c;border-radius:10px;margin-bottom:24px;">
                                <tr>
                                    <td style="padding:20px;text-align:center;">
                                        <p style="margin:0 0 6px;color:#0a5c3c;font-size:11px;font-weight:bold;letter-spacing:1px;text-transform:uppercase;">Verification Code</p>
                                        <p style="margin:0;color:#063d28;font-size:28px;font-weight:bold;font-family:Courier New,monospace;letter-spacing:4px;">{{ $visitRequest->verification_code }}</p>
                                    </td>
                                </tr>
                            </table>
